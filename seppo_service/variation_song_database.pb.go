...
func (*VariationSongDatabases) Descriptor() ([]byte, []int) { return fileDescriptor13, []int{0} }
...
func init() { proto.RegisterFile("variation_song_database.proto", fileDescriptor13) }
