...
func (*SongDatabaseVariation) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
func (*SongDatabaseVariations) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func init() { proto.RegisterFile("song_database_variation.proto", fileDescriptor10) }
