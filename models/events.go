...
var (
	eventColumns               = []string{"id", "name", "start", "end", "created_at", "updated_at", "deleted_at"}
	eventColumnsWithoutDefault = []string{"name", "start", "end", "created_at", "updated_at", "deleted_at"}
...
func (o *Event) EventSchedulesG(mods ...qm.QueryMod) eventScheduleQuery {
...
func (o *Event) EventSchedules(exec boil.Executor, mods ...qm.QueryMod) eventScheduleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`event_schedules`.`event_id`=?", o.ID),
	)
...
func (eventL) LoadEventSchedules(e boil.Executor, singular bool, maybeEvent interface{}) error {
	var slice []*Event
	var object *Event
	...
	query := fmt.Sprintf(
		"select * from `event_schedules` where `event_id` in (%s)",
...
func (o *Event) AddEventSchedulesG(insert bool, related ...*EventSchedule) error {
...
// Sets related.R.Event appropriately.
// Panics on error.
func (o *Event) AddEventSchedulesP(exec boil.Executor, insert bool, related ...*EventSchedule) {
...
func (o *Event) AddEventSchedulesGP(insert bool, related ...*EventSchedule) {
...
// Appends related to o.R.EventSchedules.
// Sets related.R.Event appropriately.
func (o *Event) AddEventSchedules(exec boil.Executor, insert bool, related ...*EventSchedule) error {
	var err error
...
func FindEventG(id uint64, selectCols ...string) (*Event, error) {
	return FindEvent(boil.GetDB(), id, selectCols...)
}

// FindEventGP retrieves a single record by ID, and panics on error.
func FindEventGP(id uint64, selectCols ...string) *Event {
...
func FindEvent(exec boil.Executor, id uint64, selectCols ...string) (*Event, error) {
	eventObj := &Event{}
...
func FindEventP(exec boil.Executor, id uint64, selectCols ...string) *Event {
...
func EventExists(exec boil.Executor, id uint64) (bool, error) {
	var exists bool
...
func EventExistsP(exec boil.Executor, id uint64) bool {
